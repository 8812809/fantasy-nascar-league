window.LEAGUE_DATA = {
  ...
  "segment": 2,
  "races_completed": 5,
  "current_race": "Coronado Naval Base",
  "next_race": "Sonoma Raceway",
  ...
  "notes": [
    ...
    "Charlotte Race 1 detailed results added from workbook and NASCAR PDF.",
    "Coronado Race 5 results added; weekly side bet winner Team 5 JJ / George.",
    "Team 2 locked after #48 Alex Bowman to #38 Zane Smith effective Michigan.",
    "Teams 4 and 5 locked after #6 Brad Keselowski to #43 Erik Jones effective Coronado.",
    "Team 6 locked after #1 Ross Chastain to #71 Michael McDowell effective Coronado.",
    "Visual request: make menu button larger and increase fonts slightly; may require HTML/CSS file updates if pages do not read display_settings."
  ],
